...
if (isset($_GET['did'])) {
    ...
    $queryst = "SELECT * from add_gallery where id='$did'"; 
   ...
   //echo $imageUrl; die;
    if(file_exists($imageUrl)){
      ...
      //delete the image
        unlink($imageUrl); 
    $sql = 'DELETE From add_gallery WHERE id="' . $did . '"'; 
    $conn->query($sql);
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `add_gallery`(`name`, `img`, `status`, `date`) 
...
<div class="page-wrapper">
    <div class="page-content">
                ...
                <div class="card border-top border-0 border-4 border-info">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-info">Add Portfolio Image</h5>
                        </div>
                        <hr>
                        <form name="form1" action="add_gallery.php" class="row g-3" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                <button name="submit" type="submit" id="" class="btn btn-info px-5">Add Portfolio</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <!--end row-->
        <div class="row">
            <h6 class="mb-0 text-uppercase">All Portfolio images</h6>
            <hr />
            ...
            $i = '1'; while ($firm = mysqli_fetch_array($result)) {  ?>
                <div class="col">
                    <div class="card border-success border-bottom border-3 border-0">
                        <img src="gallery_img/<?php echo $firm['img']; ?>" class="card-img-top" alt="<?php echo $firm['name']; ?>">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <a href="add_gallery.php?did=<?php echo $firm['id']; ?>" class="btn btn-danger"><i class="lni lni-trash"></i></a>
                            </div>
                        </div>
                    </div>
                </div>  <?php $i++;  } ?>
