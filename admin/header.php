<?php
   ...
   if(!isset($_SESSION['EINIX_ADMIN'])){
    ...
    include("config.php");
     ...
     $firm_name=$firmsst['fname'];
     $firm_address=$firmsst['faddress'];
     $firm_logo=$firmsst['flogo'];
     $firm_email=$firmsst['femail'];
     $firm_phone=$firmsst['fphone'];
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				<li><a href="home.php" class="has-arrow">
				...
				<li class="menu-label">Admin Control</li>
				...
				<!--</li>-->
				<li>
					<a href="firm_detail.php">
						<div class="parent-icon"><i class='bx bx-shape-polygon'></i>
						</div>
						<div class="menu-title">Firm Details</div>
					</a>
				</li>
				<!-- <li>-->
				<!--	<a href="emp_query.php">-->
				...
				<li>
					<a href="query.php">
						...
						<div class="menu-title">All Query</div>
					</a>
				</li>
				<li>
					<a href="profile.php">
				...
				<nav class="navbar navbar-expand">
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="logo/<?php echo $firm_logo; ?>" class="user-img" alt="user avatar">
