...
if (isset($_GET['did'])) {
    ...
    $queryst = "SELECT * from add_news where id='$did'"; 
   ...
   //echo $imageUrl; die;
    if(file_exists($imageUrl)){
      ...
      //delete the image
        unlink($imageUrl); 
    $sql = 'DELETE From add_news WHERE id="' . $did . '"'; 
    $conn->query($sql);
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `add_news`(`name`, `img`, `status`, `date`) 
...
<div class="page-wrapper">
    <div class="page-content">
                ...
                <div class="card border-top border-0 border-4 border-info">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-info">Add News Image</h5>
                        </div>
                        <hr>
                        <form name="form1" action="add_news.php" class="row g-3" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                <button name="submit" type="submit" id="" class="btn btn-info px-5">Add News</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <!--end row-->
        <div class="row">
            <h6 class="mb-0 text-uppercase">All News images</h6>
            <hr />
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 row-cols-xl-4">
            <?php  $query = "SELECT * FROM add_news ";
...
<script src="assets/plugins/notifications/js/lobibox.min.js"></script>
 ...
 <script>
    $(document).ready(function() {
       ...
       if (msgid=='1'){
        var ff1="News Image Added Successful";
        msgBox_green(ff1);
       // error_staff(ff1);
       } else if (msgid=='2'){
