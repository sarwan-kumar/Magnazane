                     ...
                     <div class="row">
                         <div class="col-md-10 offset-md-1 col-sm-12 offset-sm-0 col-lg-8 offset-lg-2">
                             <div class="blg-dtl-wrp">
                                 ...
                                 <h1 class="col-md-12">Description</h1>
                                 <div class="description col-12">


                                     <?php
                                        $id = isset($_GET['sid']) ? $_GET['sid'] : null;
                                        $query = "SELECT description FROM tbl_services WHERE id = ?";
                                        ...
                                        if ($row !== null) {
                                            if ($row['description'] !== '') {
                                                ...
                                                echo "Description is empty for this Product.";
                                            }
                                        } else {
                                            echo "No description found for this Product.";
                                        }
                                        ?>
